...
function CoachMessage({ msg }) {
  ...
  return (
    <div className={`flex ${isUser ? "justify-end" : "justify-start"} mb-3 animate-fade-in`}>
      {!isUser && (
        <div className="w-7 h-7 rounded-lg bg-[#459492]/20 flex items-center justify-center shrink-0 mr-2 mt-1">
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4 space-y-1 bg-[#F8FAFB]">
            {isLoadingHistory ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-center px-4">
                <div className="w-16 h-16 rounded-2xl bg-[#459492]/20 flex items-center justify-center mb-4">
