    ...
    return (
      <Card className="border-[#E48C75]/30 bg-gradient-to-br from-[#E48C75]/5 to-[#E48C75]/5">
        <CardContent className="p-6 text-center">
          <div className="w-14 h-14 rounded-full bg-[#E48C75]/30 flex items-center justify-center mx-auto mb-4">
          ...
          <Link to="/pricing">
            <Button variant="outline" className="border-[#E48C75]/30 text-[#E48C75] hover:bg-[#E48C75]/30">
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#5DB786]/30 flex items-center justify-center">
        ...
        {analytics.milestones?.next && (
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#E48C75]/30 flex items-center justify-center">
            ...
            <div className="space-y-3">
              {analytics.streak_history.slice(0, 5).map((streak, i) => (
                ...
                >
                  ...
                  {i === 0 && (
                    <Badge className="bg-[#E48C75]/30 text-[#E48C75] text-xs">Meilleur</Badge>
                  )}
                </div>
              ))}
            </div>
