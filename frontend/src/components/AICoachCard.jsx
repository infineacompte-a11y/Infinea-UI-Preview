...
const COACH_MODES = {
  post_completion: {
    icon: Trophy,
    badge: "Bravo !",
    badgeColor: "bg-[#5DB786]/10 text-[#5DB786]",
  ...
  post_abandon: {
    icon: HandHeart,
    badge: "On continue",
    badgeColor: "bg-[#C97A3D]/10 text-[#C97A3D]",
    glowFrom: "from-[#C97A3D]/30",
    iconBg: "from-[#C97A3D]/20 to-[#C97A3D]/5",
    iconRing: "ring-[#C97A3D]/10",
    iconColor: "text-[#C97A3D]",
    subtitle: "Pas de pression",
  },
  streak_milestone: {
    icon: Flame,
    badge: "Milestone !",
    badgeColor: "bg-[#D4956B]/10 text-[#D4956B]",
    glowFrom: "from-[#E48C75]/30",
    iconBg: "from-[#E48C75]/20 to-[#E48C75]/5",
    iconRing: "ring-[#D4956B]/10",
    iconColor: "text-[#D4956B]",
