...
const MASTERY_COLORS = {
  ...
  "Débutant": { bar: "bg-[#459492]", text: "text-[#459492]", bg: "bg-[#459492]/30" },
  "En progression": { bar: "bg-[#5DB786]", text: "text-[#5DB786]", bg: "bg-[#5DB786]/30" },
  "Intermédiaire": { bar: "bg-[#E48C75]", text: "text-[#E48C75]", bg: "bg-[#E48C75]/30" },
  "Avancé": { bar: "bg-[#E48C75]", text: "text-[#E48C75]", bg: "bg-[#E48C75]/30" },
    ...
    <div className="space-y-4">
      ...
      <Card className="p-4 opacity-0 animate-fade-in">
        <div className="flex items-center justify-between mb-3">
          ...
          {review_needed > 0 && (
            <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-[#E48C75]/30 border border-[#E48C75]/20">
...
const MOMENTUM_CONFIG = {
  rising: { icon: TrendingUp, color: "text-[#5DB786]", bg: "bg-[#5DB786]/30", border: "border-[#5DB786]/20" },
  stable: { icon: Minus, color: "text-[#459492]", bg: "bg-[#459492]/30", border: "border-[#459492]/20" },
  declining: { icon: TrendingDown, color: "text-[#E48C75]", bg: "bg-[#E48C75]/30", border: "border-[#E48C75]/20" },
};
