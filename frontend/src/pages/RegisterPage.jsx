  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative">
        ...
        <Card className="bg-card/80 backdrop-blur-xl border-border/50 rounded-2xl shadow-2xl opacity-0 animate-fade-in" style={{ animationDelay: "100ms", animationFillMode: "forwards" }}>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="opacity-0 animate-fade-in" style={{ animationDelay: "200ms", animationFillMode: "forwards" }}>
              <Button
                variant="outline"
                className="w-full h-12 rounded-xl hover:bg-muted/80 transition-all duration-200 active:scale-[0.97]"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2 opacity-0 animate-fade-in" style={{ animationDelay: "300ms", animationFillMode: "forwards" }}>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 h-12 rounded-xl focus:ring-2 focus:ring-[#459492]/50 focus:border-[#459492] transition-all"
                    value={formData.name}
              ...
              <div className="opacity-0 animate-fade-in" style={{ animationDelay: "700ms", animationFillMode: "forwards" }}>
                <Button
                  type="submit"
                  className="w-full h-12 text-base font-semibold rounded-xl shadow-md bg-gradient-to-r from-[#459492] to-[#55B3AE] hover:shadow-lg transition-all duration-200 active:scale-[0.97]"
                  disabled={isLoading}
