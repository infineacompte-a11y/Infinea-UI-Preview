...
const moodIcons = {
  positive: { icon: Smile, color: "text-[#5DB786]", bg: "bg-[#5DB786]/30", label: "Positif" },
  neutral: { icon: Meh, color: "text-[#E48C75]", bg: "bg-[#E48C75]/30", label: "Neutre" },
  negative: { icon: Frown, color: "text-[#E48C75]", bg: "bg-[#E48C75]/30", label: "Difficile" },
};
