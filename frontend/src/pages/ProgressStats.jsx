          ...
          {isLoading ? (
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <Card className="stat-card stat-card-accent bg-gradient-to-br from-[#5DB786]/20 to-[#5DB786]/5 hover:shadow-md hover:border-[#5DB786]/30 transition-all duration-300 opacity-0 animate-fade-in" style={{ "--stat-accent-color": "#5DB786", animationDelay: "0ms", animationFillMode: "forwards" }}>
                ...
                <Card className="stat-card stat-card-accent bg-gradient-to-br from-[#459492]/20 to-[#459492]/5 hover:shadow-md hover:border-[#459492]/30 transition-all duration-300 opacity-0 animate-fade-in" style={{ "--stat-accent-color": "#459492", animationDelay: "50ms", animationFillMode: "forwards" }}>
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                ...
                <Card className="stat-card stat-card-accent bg-gradient-to-br from-[#E48C75]/20 to-[#E48C75]/5 hover:shadow-md hover:border-[#E48C75]/30 transition-all duration-300 opacity-0 animate-fade-in" style={{ "--stat-accent-color": "#E48C75", animationDelay: "100ms", animationFillMode: "forwards" }}>
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-xl bg-[#E48C75]/20 flex items-center justify-center">
                ...
                <Card className="stat-card stat-card-accent bg-gradient-to-br from-[#55B3AE]/20 to-[#55B3AE]/5 hover:shadow-md hover:border-[#55B3AE]/30 transition-all duration-300 opacity-0 animate-fade-in" style={{ "--stat-accent-color": "#55B3AE", animationDelay: "150ms", animationFillMode: "forwards" }}>
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-xl bg-[#459492]/20 flex items-center justify-center">
