...
const INTERESTS = [
  { id: "learning", label: "Apprentissage", color: "text-[#459492] bg-[#459492]/30" },
  { id: "productivity", label: "Productivité", color: "text-[#E48C75] bg-[#E48C75]/30" },
  { id: "well_being", label: "Bien-être", color: "text-[#5DB786] bg-[#5DB786]/30" },
  { id: "creativity", label: "Créativité", color: "text-[#55B3AE] bg-[#55B3AE]/30" },
  { id: "fitness", label: "Forme physique", color: "text-[#E48C75] bg-[#E48C75]/30" },
  { id: "mindfulness", label: "Pleine conscience", color: "text-[#459492] bg-[#459492]/30" },
  ...
  { id: "entrepreneurship", label: "Entrepreneuriat", color: "text-[#E48C75] bg-[#E48C75]/30" },
];
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#F8FAFB] via-white to-[#F0F7F7] flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center animate-fade-in">
          <div className="w-20 h-20 rounded-full bg-[#459492]/30 flex items-center justify-center mx-auto mb-6">
