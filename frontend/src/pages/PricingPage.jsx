        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="opacity-0 animate-fade-in" style={{ animationDelay: "100ms", animationFillMode: "forwards" }}>
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#E48C75]/30 border border-[#E48C75]/20 mb-6">
          ...
          <div className="opacity-0 animate-fade-in" style={{ animationDelay: "600ms", animationFillMode: "forwards" }}>
            <div className="max-w-4xl mx-auto mb-16">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  { icon: Palette, name: "Créativité", color: "text-[#55B3AE]", bg: "bg-[#55B3AE]/30" },
                  { icon: Dumbbell, name: "Fitness", color: "text-[#E48C75]", bg: "bg-[#E48C75]/30" },
                  { icon: Leaf, name: "Mindfulness", color: "text-[#459492]", bg: "bg-[#459492]/30" },
                  ...
                  { icon: Trophy, name: "Entrepreneuriat", color: "text-[#E48C75]", bg: "bg-[#E48C75]/30" },
