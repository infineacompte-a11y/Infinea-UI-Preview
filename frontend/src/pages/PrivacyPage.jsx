    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-24 pb-16 px-4 animate-fade-in">
        <div className="max-w-3xl mx-auto prose prose-invert prose-sm">
          <h1 className="font-heading text-3xl font-bold mb-2 text-foreground">Politique de Confidentialité</h1>
          <p className="text-muted-foreground mb-8">Dernière mise à jour : 7 mars 2026</p>

          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">1. Responsable du traitement</h2>
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">2. Données collectées</h2>
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">3. Utilisation des données Google</h2>
            <p className="text-muted-foreground leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">4. Finalités du traitement</h2>
            <ul className="text-muted-foreground space-y-2 list-disc list-inside">
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">5. Base légale du traitement</h2>
            <ul className="text-muted-foreground space-y-2 list-disc list-inside">
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">6. Durée de conservation</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">7. Vos droits</h2>
            <p className="text-muted-foreground leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">8. Suppression de vos données</h2>
            <p className="text-muted-foreground leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">9. Hébergement et sécurité</h2>
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">10. Cookies et traceurs</h2>
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">11. Transferts de données</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">12. Contact et réclamation</h2>
            <p className="text-muted-foreground leading-relaxed">
