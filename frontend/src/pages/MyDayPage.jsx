...
// ─── Time of day helpers ──────────────────────────────────
const TIME_SECTIONS = [
  { key: "morning", label: "Matin", icon: Sunrise, color: "text-[#E48C75]", bgColor: "bg-[#E48C75]/30" },
  { key: "afternoon", label: "Après-midi", icon: Sun, color: "text-[#E48C75]", bgColor: "bg-[#E48C75]/30" },
  { key: "evening", label: "Soir", icon: Moon, color: "text-[#459492]", bgColor: "bg-[#459492]/30" },
];
...
const MI_SOURCE_CONFIG = {
  calendar_gap: { icon: Calendar, label: "Calendrier", color: "text-[#459492]", bgColor: "bg-[#459492]/30" },
  routine_window: { icon: Repeat, label: "Routine", color: "text-[#5DB786]", bgColor: "bg-[#5DB786]/30" },
                              ...
                              >
                                <div className="flex items-center justify-between">
                                  ...
                                  {!isDoneToday ? (
                                    ...
                                    <Badge variant="outline" className="text-[10px] bg-[#5DB786]/30 text-[#5DB786] border-[#5DB786]/20 shrink-0">
                                      Complétée
                                    </Badge>
                                  )}
                                </div>
