      ...
      <main className="lg:ml-64 pt-20 lg:pt-8 px-4 lg:px-8 pb-8">
        <div className="max-w-3xl mx-auto">
          ...
          <Card className="mb-6 hover:border-[#459492]/20 transition-all opacity-0 animate-fade-in" style={{ animationDelay: "100ms", animationFillMode: "forwards" }}>
            ...
            <CardContent>
              <div className="flex items-center justify-between p-4 rounded-xl bg-gradient-to-br from-[#459492]/10 to-transparent border border-[#262626]/50 mb-4">
                <div>
          ...
          <Card className="mb-6 hover:border-[#459492]/20 transition-all opacity-0 animate-fade-in" style={{ animationDelay: "200ms", animationFillMode: "forwards" }}>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-gradient-to-br from-[#459492]/10 to-transparent border border-[#262626]/50 hover:shadow-md hover:border-[#459492]/30 transition-all duration-300">
                ...
                <div className="p-4 rounded-xl bg-gradient-to-br from-[#E48C75]/10 to-transparent border border-[#262626]/50 hover:shadow-md hover:border-[#E48C75]/30 transition-all duration-300">
