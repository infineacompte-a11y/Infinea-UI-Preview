    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="lg:ml-64 pt-20 lg:pt-8 px-4 lg:px-8 pb-8">
        <div className="max-w-3xl mx-auto animate-fade-in">
          ...
          {/* Profile Card */}
          <Card className="mb-6 hover:border-[#459492]/20 transition-all">
          ...
          <Card className="mb-6 hover:border-[#459492]/20 transition-all">
            ...
            <CardContent>
              <div className="flex items-center justify-between p-4 rounded-xl bg-[#1A1A1A]/50 border border-[#262626]/50 mb-4">
                <div>
          ...
          <Card className="mb-6 hover:border-[#459492]/20 transition-all">
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-[#1A1A1A]/50 border border-[#262626]/50">
          ...
          <Card className="hover:border-[#459492]/20 transition-all">
            ...
            <CardContent className="space-y-2">
              <Link to="/progress">
                <button className="w-full flex items-center justify-between p-4 rounded-xl hover:bg-[#1A1A1A]/80 transition-all hover:border-[#459492]/10">
              ...
              <button
                ...
                className="w-full flex items-center justify-between p-4 rounded-xl hover:bg-[#1A1A1A]/80 transition-all hover:border-[#459492]/10 text-destructive"
