    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-24 pb-16 px-4 animate-fade-in">
        <div className="max-w-3xl mx-auto prose prose-invert prose-sm">
          <h1 className="font-heading text-3xl font-bold mb-2 text-foreground">Conditions Générales d'Utilisation</h1>
          <p className="text-muted-foreground mb-8">Dernière mise à jour : 7 mars 2026</p>

          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">1. Objet</h2>
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">2. Acceptation des CGU</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">3. Accès au service</h2>
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">4. Description du service</h2>
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">5. Offres et tarifs</h2>
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">6. Obligations de l'utilisateur</h2>
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">7. Propriété intellectuelle</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">8. Responsabilité</h2>
            <p className="text-muted-foreground leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">9. Données personnelles</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">10. Résiliation</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">11. Modification des CGU</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">12. Droit applicable</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="font-heading text-xl font-semibold mb-3 text-foreground">13. Contact</h2>
            <p className="text-muted-foreground leading-relaxed">
